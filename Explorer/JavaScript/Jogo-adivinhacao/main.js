...
let ramdomNumber = Math.round(Math.random() * 10) //numero aleatorio

let xAttempts = 1 //variavel de controle de tentativas

//função callback(chamar de volta)(função que é passada como argumento de uma outra função e mais tarde vai ser executada)
